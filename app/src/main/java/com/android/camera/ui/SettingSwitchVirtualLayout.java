...
public class SettingSwitchVirtualLayout extends RotateLayout implements
    ...
    public void onItemClick(AdapterView<?> parent, View view, int index, long id) {
        ...
        int type = -1;
        if (((index == 0 || index == 1) && (mPrefs[0].findIndexOfValue(mPrefs[0].getValue()) == 1
                && mPrefs[1].findIndexOfValue(mPrefs[1].getValue()) == 1))
                || (index == 0 && (mPrefs[0].findIndexOfValue(mPrefs[0].getValue()) == 0
                && mPrefs[1].findIndexOfValue(mPrefs[1].getValue()) == 1))
                || (index == 1 && (mPrefs[0].findIndexOfValue(mPrefs[0].getValue()) == 1
                && mPrefs[1].findIndexOfValue(mPrefs[1].getValue()) == 0))) {
            type = 1;
        } else  {
            type = 2;
        }
        ...
        Log.i(TAG, "pref.getValue = " + value + ", ind = " + ind);
         ...
         if (!mIsChecked && mPrefs[0].findIndexOfValue(mPrefs[0].getValue()) == 1
                 && mPrefs[1].findIndexOfValue(mPrefs[1].getValue()) == 1) {
             mIsChecked = false;
         } else {
             mIsChecked = true;
