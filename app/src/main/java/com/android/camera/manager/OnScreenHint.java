...
public class OnScreenHint implements OnOrientationListener {
    ...
    private final Runnable mShow = new Runnable() {
        ...
        public void run() {
            ...
            if (mContext instanceof CameraActivity) { // observe orientation
                                                      // changed.
                ((CameraActivity) mContext).addOnOrientationListener(OnScreenHint.this);
    ...
    private final Runnable mHide = new Runnable() {
        ...
        public void run() {
            ...
            if (mContext instanceof CameraActivity) { // stop observe
                                                      // orientation changed.
                ((CameraActivity) mContext).removeOnOrientationListener(OnScreenHint.this);
            }
        }
    };
    ...
    private static final int TOAST_DURATION_SHORT = 3000;
    ...
    public void showToastForShort() {
        ...
        mHandler.removeCallbacks(mHide);
        mHandler.post(mShow);
        mHandler.postDelayed(mHide, TOAST_DURATION_SHORT);
    }
}
