...
public class SettingGenerator {
    ...
    public static final int VSDOF_QUALITY_MEDIUM = 3101;
    public static final int VSDOF_QUALITY_HIGH = 3102;
    ...
    private static final String VIDEO_QUALITY_VSDOF_MEDIUM =
            Integer.toString(VSDOF_QUALITY_MEDIUM);
...
//                        " exist: " + "width=" + videoWidth + ",height=" + videoHeight);
    ...
    private ArrayList<String> getRefocusSupportedVideoQuality() {
        ...
        if (CamcorderProfile.hasProfile(cameraId,
                VSDOF_QUALITY_MEDIUM)) {
            supported.add(VIDEO_QUALITY_VSDOF_MEDIUM);
        }
        if (CamcorderProfile.hasProfile(cameraId,
                VSDOF_QUALITY_HIGH)) {
