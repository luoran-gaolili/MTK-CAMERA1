...
public class EffectView extends CameraView implements EffectLayout.OnItemClickListener {
    ...
    public EffectView(Activity activity) {
        super(activity);
        Log.d(TAG, "[EffectView]constructor...");
    }
    ...
    public void onOrientationChanged(int orientation) {
        Log.d(TAG, "onOrientationChanged( " + orientation + ")" + ", mOrientation:" + mOrientation);
    ...
    public void showEffect() {
        ...
        Log.d(TAG, "[showEffect]..., end");
    }

    public void onSizeChanged(int width, int height) {
        Log.d(TAG, "input onSizeChanged(), inputSize, width:" + width + ", height:" + height
            ...
            if (mGridView != null) {
                ...
                mMainHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(TAG, "setDisplaySize(" + mDisplayWidth + "," + mDisplayHeight + ")");
                        if (mGridView != null) {
        ...
        Log.d(TAG, "onSizeChanged(), outputSize, mDisplayWidth:" + mDisplayWidth
    ...
    public void hideEffect(boolean animation, long delay) {
        Log.d(TAG, "hideEffect(), animation:" + animation + ", mEffectsLayout:" +
                "" + mEffectsLayout);
        if (mEffectsLayout != null) {
            mMainHandler.removeMessages(MSG_REMOVE_GRID);
            mShowEffects = false;
    ...
    private void rotateGridViewItem(int orientation) {
        Log.d(TAG, "rotateGridViewItem(), orientation:" + orientation);
    ...
    private void initialEffect() {
        Log.d(TAG, "[initialEffect]mEffectsLayout:" + mEffectsLayout + ", mSizeChanged:"
        ...
        if (mEffectsLayout == null) {
            ...
            Log.d(TAG, "nums of effect:" + mNumsOfEffect);
            if (mListener != null) {
            ...
            mGridView.setOnScrollListener(new OnScrollListener() {
                ...
                public void onScrollDone(EffectLayout view, int startPosition, int endPosition) {
                    Log.d(TAG, "onScrollDone(), startPosition:" + startPosition + ", endPosition:"
                            + endPosition);
    ...
    private int getEffectId(String effectName) {
        for (int i = 0; i < mEffectName.length; i++) {
            if (Util.equals(effectName, mEffectName[i])) {
                Log.d(TAG, "effectName:" + effectName + ", effetId:" + i);
                return i;
            }
        }
        Log.d(TAG, "effectName:" + effectName + ", effetId: -1");
        return -1;
    }
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mEffectsLayout == null) {
                Log.d(TAG, "mEffectsLayout is null");
                return null;
            }
    ...
    public class LomoSurfaceTextureListener implements TextureView.SurfaceTextureListener {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            Log.d(TAG, "onSurfacetTextureAvailable(), surface:" + surface + ", width:" + width
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            Log.d(TAG, "onSurfaceTextureUpdated(), surface:" + surface + ", width:" + width
                    + ", height:" + height);
        }

        @Override
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
            Log.d(TAG, "onSurfaceTextureDestroyed(), surface:" + surface + "and mPosition:"
                    + mPosition);
